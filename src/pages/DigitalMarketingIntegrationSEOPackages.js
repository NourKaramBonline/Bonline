    ...
    const packages = [
        {
            ...
            color: 'blue',
            features: [
                { name: 'Essential On-Page SEO (Meta Tags, Alt Attributes, Headings)', status: true },
                { name: 'XML Sitemap and Robots.txt Setup', status: true },
                { name: 'Structured Data (Schema.org)', status: false },
                { name: 'Google Analytics', status: 'Google Search Console' },
                ...
                { name: 'Social Media Tools', status: 'FB or IG (one platform)' },
                { name: 'Email Marketing Tools', status: 'Basic subscription form without personalization' },
                { name: <span><span style={{color: '#007bff', fontWeight: '500'}}>Standard</span> contact form</span>, status: true },
        ...
        },
        {
            ...
            features: [
                ...
                { name: 'Google Analytics', status: 'Google Search Console, Bing Webmaster Tools' },
                { name: 'Traffic and Performance Monitoring', status: true },
                { name: 'Custom Dashboards', status: false },
                { name: 'E-commerce Tracking', status: false },
                { name: 'Heatmaps and Session Replay', status: false },
                ...
                { name: 'Email Marketing Tools', status: 'Mailchimp, Sendinblue,Klaviyo with personalized' },
                { name: <span><span style={{color: '#007bff', fontWeight: '500'}}>Lead capture</span> contact forms</span>, status: true },
        ...
        },
        {
            ...
            features: [
                ...
                { name: 'XML Sitemap and Robots.txt Setup', status: true },
                { name: 'Structured Data (Schema.org)', status: true },
                { name: 'Google Analytics', status: 'Google Tag Manager, Bing Webmaster Tools' },
                { name: 'Traffic and Performance Monitoring', status: true },
                ...
                { name: <span><span style={{color: '#007bff', fontWeight: '500'}}>Dynamic lead capture</span> contact forms</span>, status: true },
                { name: <span>Marketing Automation <span style={{color: '#007bff', fontWeight: '500'}}>Complex</span> Tools</span>, status: true },
